...
set_post_thumbnail_size( 200, 110, true ); // Normal post thumbnails
...
/*-----------------------------------------------------------------------------------*/
/*	Register and load fish tank
/*-----------------------------------------------------------------------------------*/
function tz_register_fishtank(){
	if(!is_admin()){
		wp_register_script('three'                  , get_template_directory_uri() . '/js/fishtank/Three.js'                );
		wp_register_script('fish'                   , get_template_directory_uri() . '/js/fishtank/Fish.js'                 , 'three');
		wp_register_script('request_animation_frame', get_template_directory_uri() . '/js/fishtank/RequestAnimationFrame.js');
		wp_register_script('swimming_fish'          , get_template_directory_uri() . '/js/fishtank/swimming_fish.js'        , array('three', 'fish', 'request_animation_frame'));
		wp_register_script('fish_bubbles'           , get_template_directory_uri() . '/js/fishtank/fish_bubbles.js'         );

		wp_enqueue_script('three');
		wp_enqueue_script('fish');
		wp_enqueue_script('request_animation_frame');
		wp_enqueue_script('swimming_fish');
		wp_enqueue_script('fish_bubbles');
	}
}
add_action('init', 'tz_register_fishtank');
...
// Add rss ticker widget
include('functions/widget-rss-ticker.php');
